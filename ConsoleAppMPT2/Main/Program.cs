...
using Turbo.Az.Models.Configurations;
...
namespace Turbo.Az.Main
{
    internal class Program
    {
        ...
        l6:
            ...
            TypeOfTransMissions transmission;
            foreach (var item in Enum.GetValues(typeof(TypeOfTransMissions)))
            {
                Console.WriteLine($"{(int)item}-{item}");
            }
        ...
        l7:
            ...
            if (Enum.IsDefined(typeof(TypeOfTransMissions), transmissionNum))
            {
                transmission = (TypeOfTransMissions)transmissionNum;
            }
            else
            {
                Console.WriteLine("Sehv secim etdiniz1 yeniden cehd edin!");
